...
Self-hosted API to convert HTML to high-quality PDF documents using headless Chromium. Supports custom page sizes, margins, backgrounds, thumbnails, and file storage. Ships as a lightweight Docker image.
...
```json
{
  "filename": "report.pdf",
  "data": "JVBERi0xLjcK...",
  "thumbnails": [{ "page": 1, "width": 200, "height": 283, "data": "iVBOR..." }]
}
```
  ...
  "thumbnails": [
    {
      ...
      "width": 200,
      "height": 283,
      "downloadUrl": "/downloads/pdfs/abc-123/thumbnails/page-1.png?signature=..."
    }
  ]
}
```
...
- The HTTP API returns download URLs when storage is enabled.
